...
# Initial filtering
## snRNA
- Notebook: `Data_proccessing/snRNA_01_indSample_processing_SinglomeAndMultiome.ipynb`
- General process:
...
## snATAC
- Notebooks:
  - Initial sample filtering -- scanPy  `Data_proccessing/snATAC_01_indSample_processing.ipynb`
  - Amulet:
    - Step 1: Modify cellranger singlecell.csv file to keep all post QC barcodes
      - notebook: `Data_proccessing/snATAC_02_AMULET_singlecellFile_singlomeOnly.ipynb`
...
## snRNA
  - clustering:`Data_proccessing/snRNA_02_mergeSamples_clusterRNA.ipynb`
## snATAC
